...
import deleted from "../../public/images/avatars/icon-delete.svg";
import edit from"../../public/images/avatars/icon-edit.svg";
import {
  Card,
  CardContent,
  Avatar,
      ...
      <>
        ...
        >
          ...
          <Card
            ...
            sx={{
              width: { xs: "390px", lg: "670px", xl: "770px" },
              borderRadius: "5px",
              marginTop: "20px",
...
export default MyCommentOfComment;
